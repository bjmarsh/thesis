...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.40\textwidth]{figs/theory/pdf_10.png}
    \includegraphics[width=0.40\textwidth]{figs/theory/pdf_10000.png}
    \caption{MMHT2014 NNLO proton parton distribution functions,
      for momentum transfer scales $Q^2=10\GeV^2$ (left) and
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=1.00\textwidth]{figs/theory/cms_xsecs}
