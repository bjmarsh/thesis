...
decays produce a multitude of highly energetic particles. Hence, the events tend to have lots of visible
energy (in the form of highly energetic jets, if the decays are to quarks, and leptons) as well as
\emph{invisible} energy (in the form of \ptmiss), if the decay products are not detectable.

Most SM processes the produce significant true \ptmiss from neutrinos also have leptons, since the
...
missing transverse momentum, but no leptons. 
