...
extract a measurement of the $W$ mass. The events with transverse mass larger than the $W$ mass
are due to the decay width of the $W$ of $\Gamma(W)=2.1\GeV$, experimental resolution on the muon momentum and \vMet vectors, and non-neutrino contributions to \vMet.
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Transverse mass of the muon-\vMet system from a CMS measurement of the $W$ production cross section \cite{CMS:w_prod}.
      The transverse mass has a rough upper bound at $M_W=80\GeV$, limited by experimental resolution and the inherent decay width of the $W$
      of $\Gamma(W)=2.1\GeV$.
            }
