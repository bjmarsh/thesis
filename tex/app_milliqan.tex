...
This background is largely reduced through the following baseline signal region selections:
...
bar pulses. The final region targets larger charges, which leave hits in 2 or more slabs.
