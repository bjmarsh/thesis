...
events with a through-going beam muon are identified, and the peak of the resulting pulse area
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{(left) Example measurement of the mean SPE area of Channel 0 (R878) at 1440 V.
      ...
      (right) An example emasurement of the mean cosmic pulse area for Channel 4, at a low HV of 850 V.
            }
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{(top) Example \Npe calibration of the four ET channels. The points in the 
      upper right are the measured low-voltage cosmic areas, and the points on the
...
show the fitted power law function throught the SPE points. The bottom plots show an example validation
