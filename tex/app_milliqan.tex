...
\cline{2-4}
 & Pred. & Obs. & Pred. \\
\hline
1 & $145\pm6$ & 144 & $141\pm6$ \\
2 & $36\pm5$ & 40 & $39\pm5$ \\
3 & $8.4\pm6.0$ & 11 & $13\pm3$ \\
4 & $2.7\pm1.8$ & 2 & $0.4\pm0.4$ \\
5 & $0.9\pm0.9$ & 1 & $0.0^{+0.6}_{-0.0}$ \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{ABCD method validations as a function of minimum bar \Npe.
      ...
      and 3 and 4 for the bottom plots).
            }
...
sections of each production mode individually, as well as an overall proton-proton inelastic
...
by up to 10\%, due to a large left tail. We correct for this, and take half the difference
...
\item Globally correlated 5\% uncertainty, from observed differences in the power law
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Scatterplots of signal region yields in 1000 calibration toys,
...
Finally, we assess a systematic on the time smearing correction applied to signal simulation.
As the time resolution discrepancies between simulation and data have an unknown origin,
the full size of the correction is used as a systematic.
