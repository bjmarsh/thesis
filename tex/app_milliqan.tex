...
\hline
1 & 0 & $[2,\;20]$ & $124\pm11$ & 129\\
2 & 0 & $>20$ & $49.9^{+6.0}_{-5.4}$ & 52\\
3 & 1 & $[5,\;30]$ & $10.7^{+3.6}_{-2.6}$ & 8\\
4 & 1 & $>30$ & $2.4^{+2.1}_{-1.1}$ & 4\\
...
The results are interpreted using the millicharged signal production model discussed in Sec.~\ref{sec:mq_mcgen}, with the systematic uncertainties on signal yields listed in
