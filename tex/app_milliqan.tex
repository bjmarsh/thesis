...
\cline{2-4}
 & Pred. & Obs. & Pred. \\
\hline
1 & $121.2^{+5.5}_{-5.8}$ & 131 & $124.2^{+6.0}_{-5.1}$ \\
2 & $47.4^{+5.7}_{-4.9}$ & 45 & $49.9^{+4.9}_{-4.4}$ \\
3 & $7.8^{+2.6}_{-2.0}$ & 9 & $10.7^{+3.3}_{-1.8}$ \\
4 & $2.7^{+2.1}_{-1.1}$ & 4 & $2.4^{+1.5}_{-0.8}$ \\
...
Uncertainties shown in the predictions include both systematic uncertainties and statistical uncertainty
from the limited size of the control regions.
...
\hline
1 & 0 & $[2,\;20]$ & $124^{+12}_{-10}$ & 129\\
2 & 0 & $>20$ & $49.9^{+5.5}_{-5.1}$ & 52\\
3 & 1 & $[5,\;30]$ & $10.7^{+3.7}_{-2.4}$ & 8\\
4 & 1 & $>30$ & $2.4^{+1.9}_{-1.2}$ & 4\\
5 & $\geq$2 & $>0.5$ & $0.0^{+0.9}_{-0.0}$ & 1 \\
\hline
\end{tabular}
\end{table}
